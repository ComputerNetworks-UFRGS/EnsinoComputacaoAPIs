...
class LearningObjectsSeeder extends Seeder
{
    ...
    private function getObjects()
    {
        return [
            ...
            ['02', 'CD', '02CDUSO', 'Uso básico de tecnologia digital'],
            ...
            ['03', 'CD', '03CDUSO', 'Uso crítico da internet'],
            ['04', 'PC', '04PCALGO', 'Algoritmos: repetição'],
            ['04', 'PC', '04PCESTR', 'Estruturas de dados estáticas: registros e vetores'],
            ...
            ['06', 'CD', '06CDTECN', 'Tecnologia digital e sociedade'],
            ['06', 'CD', '06CDTECN', 'Tecnologia digital e sustentabilidade'],
            ...
            ['09', 'CD', '09CDUSO', 'Uso crítico de tecnologias digitais'],
            ...
            ['EM', 'PC', 'EMPCTECN', 'Técnica de solução de problemas: Transformação'],
            ['EM', 'PC', 'EMPCTECN', 'Técnica de solução de problemas: Refinamento'],
            ['EM', 'MD', 'EMMDANAL', 'Análise de redes'],
            ['EM', 'MD', 'EMMDANAL', 'Análise de segurança digital'],
            ['EM', 'MD', 'EMMDBIG', 'Big data'],
